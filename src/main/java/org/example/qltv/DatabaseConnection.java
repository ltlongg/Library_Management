...
public class DatabaseConnection { // singleton pattern

    private static DatabaseConnection instance;

    private final static String jdbcUrl = "jdbc:mysql://127.0.0.1:3306/longg";
    ...
    public static DatabaseConnection getInstance() {
        if(instance == null) {//kiểm tra xem có đối tượng nào được tạo chưa
            synchronized (DatabaseConnection.class) {  // dùng để khoá đoạn code bên trong nó
                if (instance == null) {  // kiểm tra xem có đối tượng nào được tạo chưa
                    instance = new DatabaseConnection();  // nếu chưa thì tạo 1 đối tượng
                }
            }
        }
        return instance;
...
Statement là một giao diện trong JDBC (Java Database Connectivity) cho phép thực thi các câu lệnh SQL.
    ...
    public void dbUpdate(String sql) { // nhung cau query khong tra ve gia tri // update, insert, delete
        try {
            Statement statement = connection.createStatement();
